...
class Fluttertoast {
  ...
  /// 仅android使用
  static double? _sFontSize;
  static setGlobalFontSize(double fontSize) {
    _sFontSize = fontSize;
  }

  /// 仅android使用
  static FontSizeUnit? _sFontSizeUnit;
  static setGlobalFontSizeUnit(FontSizeUnit unit) {
    _sFontSizeUnit = unit;
  }
  ...
  static Future<bool?> showToast({
    ...
    double? fontSize,
    FontSizeUnit? fontSizeUnit, /// 仅android使用
    String? fontAsset,
    ...
    if (Platform.isAndroid && fontSize == null) {// android
      fontSize = _sFontSize;
    }
    if (Platform.isAndroid && fontSizeUnit == null) {// android
      fontSizeUnit = _sFontSizeUnit;
    }
...
//lines from 78 to 97 have been changed in order to solve issue #328
    ...
    final Map<String, dynamic> params = <String, dynamic>{
      ...
      'fontSize': fontSize,
      'fontSizeUnit': fontSizeUnit?.code,
      'fontAsset': fontAsset,
